                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
                         ...
                         <li>
                            <a href="<?php echo base_url();?>course"><i class="fa fa-files-o fa-fw"></i> Computer Courses</a>
                        </li>
                        
                         <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> University<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>university">University</a>
                                </li>
                                <li>
                                     <a href="<?php echo base_url();?>universitycourse">University Courses</a>
                                </li>
                                 <li>
                                     <a href="<?php echo base_url();?>unistudents">University Students</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
