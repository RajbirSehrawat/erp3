           ...
           <?php if($this->session->flashdata('success_msg')) { ?>
				...
				<?php }  ?>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                      <?php echo form_open('student/edit/'.$student_data['id']);?>
                                      <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                           <label>Discount</label>
                                            <input class="form-control" name="discount" value="<?php  if(set_value('discount')) { echo set_value('discount'); } else { echo $student_data['discount_fixed'];} ?>">
