                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <div class="form-group">
										 ...
										 <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             <label>Upload 10th</label>
											<input class="form-control" type="file" name="marksheet_sc" value=""/>	
                                         </div>
                                         </div>
										 <div class="col-md-4">
                                     
                                          <div class="form-group">
                                             <label>Upload 12th</label>
											<input class="form-control" type="file" name="marksheet_sr_sc" value=""/>	
                                         </div>
                                         </div>
										 <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                             <label>Addhar</label>
											<input class="form-control" type="file" name="adhar" value=""/>	
                                         </div>
                                         </div>
