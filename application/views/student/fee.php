                                ...
                                <div class="col-lg-12">
                                      <?php echo form_open('student/fee/'.$student_data['enrollment']);?>
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-3">
                                        <div class="form-group">
                                           <label>Discount <?php if($student_data['course_discount'] > 0) { echo "(".$student_data['course_discount']. "%)";} ?></label>
                                        ...
                                        <div class="form-group">
                                           <label>Due Date </label>
                                            <input class="form-control" id="join_date" readonly="" name="due_date" value="<?php echo date('Y-m-d');?>">
